        ...
        8634: function (t) {
          t.exports = (function () {
            ...
            var y = {
              ...
              position(t) {
                ...
                if ("manual" != e.position) {
                  ...
                  if (
                    ((t = t || l.clientHeight), this.state.dropdown.visible)
                  ) {
                    if (
                      ("text" == u
                        ? ((a = (i = (function () {
                      ...
                      switch (t.key) {
                        ...
                        case "Tab":
                          if (
                            ...
                            return (
                              this.input.autocomplete.set.call(this, n), !1
                            );
                          }
                          return !0;
                        case "Enter":
              ...
              getSuggestionDataByNode(t) {
                ...
                return (
                  this.suggestedListItems.find((t) => t.value == e) || null
                );
              },
            ...
            var O,
              ...
              M = {
                wrapper: (t, e) =>
                  `<tags class="d-flex gap-2 ${e.classNames.namespace} ${
                ...
                callbacks: {
                        ...
                        switch (t.key) {
                          ...
                          case "Backspace":
                                ...
                                ? (h =
                                    0 == s.anchorOffset
                                      ? a
                                        ...
                                        : null
                                      : p[
                                          Math.min(p.length, s.anchorOffset) - 1
                                        ])
                                : a
                            ...
                            if (
                              "Range" != s.type &&
                              h &&
                              h.hasAttribute("readonly")
                            )
                              return void this.placeCaretAfterNode(l(h));
                            clearTimeout(O),
                              (O = setTimeout(() => {
                        ...
                        if (
                          ...
                          return (
                            (this.state.tag.value =
                              this.state.tag.value.replace(d.delimiters, "")),
                  ...
                  onPaste(t) {
                    ...
                    var e,
                      ...
                      s = this.settings;
                    if (
                      ("select" == s.mode && s.enforceWhitelist) ||
                      !s.userInput
                    )
                      return !1;
                    s.readonly ||
            ...
            return (
              (N.prototype = {
                ...
                parseTemplate(t, e) {
                  return r(
                    (t = this.settings.templates[t] || t).apply(this, e)
                  );
                },
                set whitelist(t) {
                ...
                applySettings(t, i) {
                  ...
                  if (
                    ...
                    ["whitelist", "blacklist"].forEach((e) => {
                      ...
                      i &&
                        (i = i.split(a.delimiters)) instanceof Array &&
                        (a[e] = i);
                    }),
                    "autoComplete" in i &&
                      !h(i.autoComplete) &&
                  ...
                  a.disabled && (a.userInput = !1),
                    ...
                    (("select" != a.mode || i.dropdown?.enabled) &&
                      a.userInput) ||
                      (a.dropdown.enabled = 0),
                    (a.dropdown.appendTarget =
                      i.dropdown?.appendTarget || document.body);
                ...
                reCheckInvalidTags() {
                  var t = this.settings;
                  this.getTagElms(t.classNames.tagNotAllowed).forEach(
                    (e, i) => {
                      var s = T(e),
                        a = this.hasMaxTags(),
                      ...
                      .then(() => {
                        ...
                        i && i > 10 && 1 == s.length
                          ? function (e) {
                              (e.node.style.width =
                                parseFloat(
                                  window.getComputedStyle(e.node).width
                                ) + "px"),
