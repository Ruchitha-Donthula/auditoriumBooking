            ...
            (a = function (t, e) {
              ...
              h.prototype = {
                    ...
                    for (
                      ...
                      (i += '<th class="dow'),
                        -1 !== t.inArray(e, this.o.daysOfWeekDisabled) &&
                          (i += " disabled"),
                        (i +=
                          '">' + f[this.o.language].daysMin[e++ % 7] + "</th>");
                    (i += "</tr>"),
                ...
                fill: function () {
                  ...
                  if (!isNaN(r) && !isNaN(h)) {
                    this.picker
                      ...
                      .text(g.formatDate(o, m, this.o.language)),
                      this.picker
                        .find("tfoot .today")
                        .text(p)
                    ...
                    if (
                      (t.each(this.dates, function (t, e) {
                        e.getUTCFullYear() === r &&
                          A.eq(e.getUTCMonth()).addClass("active");
                      }),
                      (r < l || r > c) && A.addClass("disabled"),
                      r === l && A.slice(0, d).addClass("disabled"),
                ...
                navArrowsClick: function (e) {
                  ...
                  0 !== this.viewMode &&
                    (i *= 12 * g.viewModes[this.viewMode].navStep),
                ...
                setViewMode: function (t) {
                  (this.viewMode = t),
                    this.picker
                      ...
                      .hide()
                      .filter(
                        ".datepicker-" + g.viewModes[this.viewMode].clsName
                      )
                      .show(),
                    this.updateNavArrows(),
                      ...
                      if (-1 !== o) {
                        if (
                          ...
                          for (
                            ...
                            r >= 0 &&
                            s < this.dates[r] &&
                            (this.pickers[r].element.val() || "").length > 0;
                    ...
                    this.each(function () {
                      ...
                      if (!n) {
                        var r = (function (e, i) {
                          ...
                          c = t.extend({}, u, d, r, o);
                        e.hasClass("input-daterange") || c.inputs
                          ? (t.extend(c, {
              ...
              (g.template =
                ...
                t(document).on(
                  ...
                  function (e) {
                    var i = t(this);
                    i.data("datepicker") ||
                      (e.preventDefault(), c.call(i, "show"));
                  }
                ),
                t(function () {
